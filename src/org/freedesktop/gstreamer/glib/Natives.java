...
public final class Natives {
  ...
  private static <T extends NativeObject> T objectFor(Pointer ptr, Class<T> cls, int refAdjust, boolean ownsHandle) {
    final GPointer gptr = GObject.class.isAssignableFrom(cls) ? new GObjectPtr(ptr) : MiniObject.class.isAssignableFrom(cls) ? new GstMiniObjectPtr(ptr) : Structure.class.isAssignableFrom(cls) ? new GstStructurePtr(ptr) : new GPointer(ptr);
  ...
  public static <T extends NativeObject> NativeObject.TypeRegistration<T> registration(Class<T> javaType, String gTypeName, Function<NativeObject.Initializer, ? extends T> factory) {
