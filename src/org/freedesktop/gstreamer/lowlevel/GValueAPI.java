...
public interface GValueAPI extends Library {
  ...
  NoMapperAPI GVALUE_NOMAPPER_API = GNative.loadLibrary("gobject-2.0", NoMapperAPI.class, new HashMap<String, Object>() {});
  GValueAPI GVALUE_API = GNative.loadLibrary("gobject-2.0", GValueAPI.class, new HashMap<String, Object>() {
    {
  ...
  public static final class GValue extends com.sun.jna.Structure {
    ...
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"g_type", "data"});
    }
  ...
  public static final class GValueArray extends com.sun.jna.Structure {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"n_values", "values", "n_prealloced"});
    }
  }
