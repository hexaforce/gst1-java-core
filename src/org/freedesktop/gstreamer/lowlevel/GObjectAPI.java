...
public interface GObjectAPI extends Library {
  GObjectAPI GOBJECT_API = GNative.loadLibrary("gobject-2.0", GObjectAPI.class, new HashMap<String, Object>() {
    {
  ...
  NativeLong g_signal_connect_data(GObjectPtr obj, String signal, Callback callback, Pointer data, GClosureNotify destroy_data, int connect_flags);
  ...
  GType g_type_register_static(GType parent_type, String type_name, GTypeInfo info, int flags);

  GType g_type_register_static(GType parent_type, Pointer type_name, GTypeInfo info, int flags);

  GType g_type_register_static_simple(GType parent_type, String type_name, int class_size, GClassInitFunc class_init, int instance_size, GInstanceInitFunc instance_init, int flags);

  GType g_type_register_static_simple(GType parent_type, Pointer type_name, int class_size, GClassInitFunc class_init, int instance_size, GInstanceInitFunc instance_init, int flags);
  ...
  public static final class GObjectStruct extends com.sun.jna.Structure {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"g_type_instance", "ref_count", "qdata"});
    }
  }
  ...
  public static final class GObjectClass extends com.sun.jna.Structure {
    ...
    public static interface Constructor extends Callback {
      public Pointer callback(GType type, int n_construct_properties, GObjectConstructParam properties);
    }
    ;
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"g_type_class", "construct_properties", "constructor", "set_property", "get_property", "dispose", "finalize", "dispatch_properties_changed", "notify", "p_dummy"});
    }
  }
  ...
  public static final class GTypeInfo extends com.sun.jna.Structure {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"class_size", "base_init", "base_finalize", "class_init", "class_finalize", "class_data", "instance_size", "n_preallocs", "instance_init", "value_table"});
    }
  }

  public abstract static class GParamSpecTypeSpecific extends com.sun.jna.Structure {
  ...
  public static final class GParamSpecBoolean extends GParamSpecTypeSpecific {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"parent_instance", "default_value"});
    }
  }
  ...
  public static final class GParamSpecInt extends GParamSpecTypeSpecific {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"parent_instance", "minimum", "maximum", "default_value"});
    }
  }
  ...
  public static final class GParamSpecFloat extends GParamSpecTypeSpecific {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"parent_instance", "minimum", "maximum", "default_value", "epsilon"});
    }
  }
  ...
  public static final class GParamSpecString extends GParamSpecTypeSpecific {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"parent_instance", "default_value", "cset_first", "cset_nth", "substitutor", "null_fold_if_empty_ensure_non_null"});
    }
  }
  ...
  public static final class GParamSpec extends com.sun.jna.Structure {
    ...
    @Override
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"g_type_instance", "g_name", "g_flags", "value_type", "owner_type", "_nick", "_blurb", "qdata", "ref_count", "param_id"});
    }
  }
}
