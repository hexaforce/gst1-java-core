...
public interface BaseTransformAPI extends Library {
  ...
  public static final class GstBaseTransformStruct extends com.sun.jna.Structure {
    ...
    protected List<String> getFieldOrder() {
      return Arrays.asList(new String[] {"element", "sinkpad", "srcpad", "have_segment", "segment", "queued_buf", "priv", "_gst_reserved"});
    }
  }
  ...
  public static interface FilterMeta extends Callback {
    public boolean callback(BaseTransform trans, Query query, GType api, Pointer params);
  }
  ...
  public static interface TransformSize extends Callback {
    public boolean callback(BaseTransform trans, PadDirection direction, Caps caps, int size, Caps othercaps, IntByReference othersize);
  }
  ...
  public static interface PrepareOutput extends Callback {
    public FlowReturn callback(BaseTransform trans, Buffer input, Pointer outbuf);
  }
  ...
  public static interface TransformMeta extends Callback {
    public boolean callback(BaseTransform trans, Buffer outbuf, Pointer meta, Buffer output);
  }
  ...
  public static interface GenerateOutput extends Callback {
    public FlowReturn callback(BaseTransform trans, Pointer outbuf);
  }
