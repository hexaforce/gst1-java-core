...
public class EventTest {
  ...
  @Test
  public void createCapsEvent() throws Exception {
    new CapsEvent(Caps.fromString("video/x-raw,format=I420"));
  }

  @Test
  public void createReconfigureEvent() throws Exception {
    new ReconfigureEvent();
  }

  @Test
  public void createStreamStartEvent() throws Exception {
    new StreamStartEvent("a stream_id");
  }

  @Test
  public void createStepEvent() throws Exception {
  ...
  public void gst_event_new_seek() {
    Event ev = GSTEVENT_API.gst_event_new_seek(1.0, Format.TIME, 0, SeekType.SET, 0, SeekType.SET, 0);
  ...
  public void Seek_getFormat() {
    for (Format FORMAT : new Format[] {Format.TIME, Format.BYTES}) {
      SeekEvent ev = new SeekEvent(1.0, FORMAT, EnumSet.noneOf(SeekFlags.class), SeekType.SET, 0, SeekType.SET, 0);
  ...
  public void Seek_getStartType() {
    for (SeekType TYPE : new SeekType[] {SeekType.SET, SeekType.END}) {
      SeekEvent ev = new SeekEvent(1.0, Format.TIME, EnumSet.noneOf(SeekFlags.class), TYPE, 0, SeekType.NONE, 0);
  ...
  public void Seek_getStopType() {
    for (SeekType TYPE : new SeekType[] {SeekType.SET, SeekType.END}) {
      SeekEvent ev = new SeekEvent(1.0, Format.TIME, EnumSet.noneOf(SeekFlags.class), SeekType.NONE, 0, TYPE, 0);
  ...
  public void Seek_getStart() {
    ...
    SeekEvent ev = new SeekEvent(1.0, Format.TIME, EnumSet.noneOf(SeekFlags.class), SeekType.SET, START, SeekType.SET, -1);
  ...
  public void Seek_getStop() {
    ...
    SeekEvent ev = new SeekEvent(1.0, Format.TIME, EnumSet.noneOf(SeekFlags.class), SeekType.SET, 0, SeekType.SET, STOP);
  ...
  public void Seek_rateZero() {
    try {
      new SeekEvent(0.0, Format.TIME, EnumSet.noneOf(SeekFlags.class), SeekType.SET, 0, SeekType.SET, -1);
