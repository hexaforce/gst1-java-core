...
public class InterpolationControlSourceTest {
  ...
  public void testSetValue() {
    List<ControlSource.TimedValue> timedValue = Collections.singletonList(new ControlSource.TimedValue(ClockTime.fromSeconds(10), 0.5));
    InterpolationControlSource controller = new InterpolationControlSource();
  ...
  public void testSetValues() {
    List<ControlSource.TimedValue> timedValues = Stream.of(new ControlSource.TimedValue(ClockTime.fromSeconds(0), 0.0), new ControlSource.TimedValue(ClockTime.fromSeconds(1), 0.5), new ControlSource.TimedValue(ClockTime.fromSeconds(2), 0.2), new ControlSource.TimedValue(ClockTime.fromSeconds(4), 0.8)).collect(Collectors.toList());
    InterpolationControlSource controller = new InterpolationControlSource();
  ...
  public void testLinearInterpolation() {
    List<ControlSource.TimedValue> timedValues = Stream.of(new ControlSource.TimedValue(ClockTime.fromSeconds(0), 0.0), new ControlSource.TimedValue(ClockTime.fromSeconds(1), 1.0)).collect(Collectors.toList());
    InterpolationControlSource controller = new InterpolationControlSource();
  ...
  public void testLinearInterpolationAbsolute() {
    List<ControlSource.TimedValue> timedValues = Stream.of(new ControlSource.TimedValue(ClockTime.fromSeconds(0), 0.0), new ControlSource.TimedValue(ClockTime.fromSeconds(1), 5.0)).collect(Collectors.toList());
    InterpolationControlSource controller = new InterpolationControlSource();
    controller.setMode(InterpolationMode.LINEAR);
    controller.setFromList(timedValues);
    Element volume = ElementFactory.make("volume", "volume");
    ControlBinding binding = DirectControlBinding.createAbsolute(volume, "volume", controller);
    assertEquals(2.5, (Double) binding.getValue(ClockTime.fromMillis(500)), 0.01);
